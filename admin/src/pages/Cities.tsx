        ...
        const fetchLocations = async () => {
            ...
            try {
                ...
                if (result.success && Array.isArray(result.data)) {
                    console.log(
                        " Success format detected, setting locations:",
                        result.data,
                    );
                    ...
                    console.log(
                        " Direct array format, setting locations:",
                        result,
                    );
                    ...
                    throw new Error(
                        (result as any).message || "Unexpected response format",
                    );
                }
            } catch (err) {
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {locations.length === 0 ? (
                            <tr>
                                ...
                                >
                                    No locations found. Try adding some
                                    locations!
                                </td>
                            </tr>
                        ) : (
