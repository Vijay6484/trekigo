...
import { reviewAvatar, socialLinks, trustHighlights } from "@/lib/data";
import { SectionHeading } from "@/components/SectionHeading";
import type { WebsiteReview } from "@/lib/types";

export function TrustBlock({ reviews }: { reviews: WebsiteReview[] }) {
  return (
    <>
