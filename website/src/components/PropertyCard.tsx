...
import type { WebsiteProperty } from "@/lib/types";

export function PropertyCard({ property }: { property: WebsiteProperty }) {
  return (
    <Link
    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-surface-container-high">
        <img
          src={property.img || "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1200&q=80"}
          alt={property.name}
